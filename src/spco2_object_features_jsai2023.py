...
class ObjectFeatureServer():
    ...
    def extracting_label(self):
        ...
        for i in range(len(self.detect_object_info)):
            if self.detect_object_info[i].Class == "airplane_toy" or\
                    self.detect_object_info[i].Class == "car_toy" or\
                    self.detect_object_info[i].Class == "truck_toy" or\
                    self.detect_object_info[i].Class == "banana" or\
                    self.detect_object_info[i].Class == "apple" or\
                    self.detect_object_info[i].Class == "orange" or\
                    self.detect_object_info[i].Class == "tooth_paste" or\
                    self.detect_object_info[i].Class == "towel" or\
                    self.detect_object_info[i].Class == "cup":
                pass
            else:
